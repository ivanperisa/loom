...
INSERT INTO home.course_group (id, slot_type_id, isvu_code, name, name_en) VALUES
  ...
  (2,  8, NULL,  'Diplomski rad', 'Master thesis'),
  ...
  (108, 5, NULL,  'Mentorski seminar', 'Mentoring Seminar'),
  ...
  (121, 5, NULL,  'Mentorski seminar', 'Mentoring Seminar'),
  ...
  (143, 5, NULL,  'Mentorski seminar', 'Mentoring Seminar'),
  ...
  (159, 5, NULL,  'Mentorski seminar', 'Mentoring Seminar'),
  ...
  (172, 5, NULL,  'Mentorski seminar', 'Mentoring Seminar'),
  ...
  (190, 5, NULL,  'Mentorski seminar', 'Mentoring Seminar');
...
INSERT INTO home.slot (id, profile_id, semester, slot_position, ects, slot_type_id, course_id, course_group_id) VALUES
  ...
  (217, 101, 3, 16, 5, 4, NULL, 103), (218, 101, 3, 21, 5, 4, NULL, 103), (219, 101, 3, 26, 3, 5, NULL, 108),
  (220, 101, 3, 29, 2, 7, NULL, 107),
  -- PIIS sem4
  (221, 101, 4,  1, 30, 8, NULL, 2),
  -- RI sem1
  ...
  (239, 102, 3, 16, 5, 4, NULL, 117), (240, 102, 3, 21, 5, 4, NULL, 117), (241, 102, 3, 26, 3, 5, NULL, 121),
  (242, 102, 3, 29, 2, 7, NULL, 120),
  -- RI sem4
  (243, 102, 4,  1, 30, 8, NULL, 2),
  -- RZ sem1
  ...
  (261, 103, 3, 16, 5, 4, NULL, 139), (262, 103, 3, 21, 5, 4, NULL, 139), (263, 103, 3, 26, 3, 5, NULL, 143),
  (264, 103, 3, 29, 2, 7, NULL, 142),
  -- RZ sem4
  (265, 103, 4,  1, 30, 8, NULL, 2),
  -- ZoP sem1
  ...
  (283, 104, 3, 16, 5, 4, NULL, 155), (284, 104, 3, 21, 5, 4, NULL, 155), (285, 104, 3, 26, 3, 5, NULL, 159),
  (286, 104, 3, 29, 2, 7, NULL, 158),
  -- ZoP sem4
  (287, 104, 4,  1, 30, 8, NULL, 2),
  -- ZoM sem1
  ...
  (305, 105, 3, 16, 5, 4, NULL, 168), (306, 105, 3, 21, 5, 4, NULL, 168), (307, 105, 3, 26, 3, 5, NULL, 172),
  (308, 105, 3, 29, 2, 7, NULL, 171),
  -- ZoM sem4
  (309, 105, 4,  1, 30, 8, NULL, 2),
  -- RMI sem1
  ...
  (327, 106, 3, 16, 5, 4, NULL, 186), (328, 106, 3, 21, 5, 4, NULL, 186), (329, 106, 3, 26, 3, 5, NULL, 190),
  (330, 106, 3, 29, 2, 7, NULL, 189),
  -- RMI sem4
  (331, 106, 4,  1, 30, 8, NULL, 2);
