...
public interface IRecognitionService
{
    ...
    Task<ErrorOr<RecognitionResponse>> UpdateRecognitionStatusAsync(Guid exchangeId, Guid requesterId, UpdateRecognitionStatusRequest request, CancellationToken ct = default);
