export default {
  ...
  coordinator: {
    ...
    filters: {
      search: 'Search by name, JMBAG or institution...',
      institution: 'Foreign institution',
    ...
    table: {
      ...
      exchange: 'Exchange',
      period: 'Period',
      learningAgreement: 'Agreement',
      moreExchanges: '+{n} more',
      none: '—',
      actions: 'Actions',
      reassignedNote: 'This student now has a different coordinator; you kept this exchange because it is approved.',
    },
    deleteStudent: 'Delete student',
    deleteStudentConfirm: 'Delete this student? This cannot be undone.',
    deleteStudentHasExchanges: 'This student has exchanges. Delete them first.',
  ...
  admin: {
    ...
    institutions: {
      ...
      usage: {
        toggle: 'Show usage',
        empty: 'Not used in any exchange yet.',
        usedIn: 'Used in',
