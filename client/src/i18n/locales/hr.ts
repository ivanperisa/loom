export default {
  ...
  recognition: {
    ...
    messagePlaceholder: 'Napomene vidljive studentu i koordinatoru...',
    history: {
      title: 'Priznavanje - povijest',
      empty: 'Nema potpisivanja.',
      entries: 'stavki',
      details: 'Detalji',
      hide: 'Sakrij',
      gradeChanged: 'ocjena {before} → {after}',
      recognizedChanged: 'priznato: {before} → {after}',
      yes: 'da',
      no: 'ne',
  ...
  admin: {
    ...
    institutions: {
      ...
      courseLecturesH: 'Predavanja h',
      courseAuditoryH: 'Auditorne vj. h',
      courseLabH: 'Lab. vj. h',
      deleteCourse: 'Obriši',
