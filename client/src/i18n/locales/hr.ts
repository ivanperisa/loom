export default {
  ...
  home: {
    ...
    partnerProgram: 'Partnerski program',
  ...
  createExchange: {
    ...
    summaryPartnerProgram: 'Strani program',
    ...
    errors: {
      ...
      partnerProgramRequired: 'Odaberite strani program.',
  ...
  admin: {
    ...
    institutions: {
      ...
      searchPrograms: 'Pretraži programe...',
      ...
      programs: 'Programi',
      noPrograms: 'Nema dodanih programa.',
      addProgram: 'Dodaj program',
      programName: 'Naziv programa (hrvatski)',
      programNameEn: 'Naziv programa (engleski)',
      level: 'Razina',
      levelUndergraduate: 'Preddiplomski',
      levelGraduate: 'Diplomski',
      levelPostgraduate: 'Poslijediplomski',
      deleteProgram: 'Obriši program',
      deleteProgramConfirm: 'Obrisati ovaj program zajedno sa svim predmetima?',
      courses: 'predmeta',
      noCourses: 'Nema dodanih predmeta.',
      addCourse: 'Dodaj predmet',
      courseCode: 'Kod',
      courseNameEn: 'Naziv (engleski)',
